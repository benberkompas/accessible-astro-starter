---
title: Designing a Scalable System for Recovery Content
author: Ben Berkompas
description: I led the system design and alignment work needed to turn recovery content into a coherent, scalable product system. The focus was on shaping decisions, managing opportunity cost, and preparing the organization to evolve over time.
minutes: 10
company: Covenant Eyes
featuredImage:
  src: /projects/victory-grow/relationships.jpg
...
<Image
    src="/projects/victory-grow/object-groupings.jpg"
...
<BreakoutImage src="/projects/victory-grow/relationships.jpg" alt="How objects relate to each other" caption="Mapping relationships between objects helped us understand exactly how they would fit together, and prompted some important discussions" />
...
<Image
    src="/projects/victory-grow/object-guide.jpg"
...
Because <a href="/portfolio/aligning-conceptual-models-for-relational-accountability/" target="new">alignment is often assumed to be higher than it actually is</a>, working upstream improves decision quality and reduces downstream rework.
